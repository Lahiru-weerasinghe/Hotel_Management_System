        ...
        return (
            ...
            <div className = "jumbotron">
                <div className = "jumbotron" style={{paddingLeft:'50px', paddingRight:'50px', paddingTop: '10px', backgroundImage: `url(${image})`,backgroundRepeat:'no-repeat', backgroundSize:'cover'}}>
                    ...
                    <div>
                    <div className="jumbotron" style={{backgroundColor:'rgba(255,255,255,0.7)', marginTop:'300px', marginBottom:'100px'}}>
                        <br/>
                        <h1 style={{textAlign: 'center', fontFamily: 'Bonheur Royale', fontSize:'150px', color: 'black', fontWeight: '500'}}>Welcome to Hotel Sky Dragons</h1>
                    </div>
                        <br/><br/><br/><br/>
                        <br/><br/><br/><br/>
                        <br/><br/><br/><br/>
                    ...
                    <div className="container">
                        ...
                        <div style={{textAlign: 'center'}}>
                            ...
                            <p style={{fontSize: '20px'}}>
                                ...
                                At Hotel Sky Dragons, we promise you are in good hands. <br/>
