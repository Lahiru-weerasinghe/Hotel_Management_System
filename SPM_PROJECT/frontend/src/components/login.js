  ...
  render(){
    return(
      ...
      <body>
        ...
        backgroundSize:'cover', height:'762px'}}><br/><br/>
            ...
            <div className="form" style={{backgroundColor:'white',height:'400px',width:'400px',borderRadius:'14px',marginLeft:'140px',marginTop:'15px'}}>
                    ...
                    <form className="row" style={{ margin:"10px 85px 75px 75px"}} >
                        ...
                        <div className="form-group" style={{marginLeft:'-30px'}}>
                            <br></br>
                              <label style={{marginLeft:'-30px'}}>Contact Number</label>
                        ...
                        <button className="btn btn-success"  style={{marginLeft:"13px",borderRadius:'35px',marginTop:'20px'}}><a href="/Home" style={{textDecoration:'none',color:'white',fontFamily: 'monospace'}}>LOGIN</a></button>
