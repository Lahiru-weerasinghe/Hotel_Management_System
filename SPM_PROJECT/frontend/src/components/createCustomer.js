        ...
        <br></br>
          <form className="row" onSubmit={this.onSubmit} style={{ margin:"-30px 85px 75px 75px"}} >
            ...
            <div className="form-group col-XS-3" style={{marginBottom:'15px'}}>
               <label style={{marginLeft:'-255px', fontSize:'20px'}}>Name</label>
            ...
            <div className="form-group" style={{marginBottom:'15px'}}>
              <label style={{marginLeft:'-255px'}}>Email</label>
            ...
            <div className="form-group" style={{marginBottom:'15px'}}>
              <label style={{marginLeft:'-235px'}}>Address</label>
              <input style={{width: '300px',borderRadius: '8px',fontSize: '15px',fontFamily: 'monospace'}} type="text"
              className="form-control"
              name="address"
            ...
            <div className="form-group" style={{marginBottom:'15px'}}>
              <label style={{marginLeft:'-285px'}}>NIC</label>
              <input style={{width: '300px',borderRadius: '8px',fontSize: '15px',fontFamily: 'monospace'}} type="text"
              className="form-control"
              name="nic"
            ...
            <div className="form-group" style={{marginBottom:'15px'}}>
              <label style={{marginLeft:'-140px'}}>Contact Number</label>
              <input style={{width: '300px',borderRadius: '8px',fontSize: '15px',fontFamily: 'monospace'}} type="text"
              className="form-control"
              name="contactNumber"
             ...
             <table>
                 <tr>
                     <td>
            <button className="btn btn-success" type="submit" style={{marginLeft:"-10px",borderRadius:'35px',fontFamily: 'monospace'}} > 
             SIGNUP
            </button>
            </td>
            <td>
            ...
            <a style={{fontSize: '12px',marginLeft:"-10px",fontFamily: 'monospace',color: 'blue'}}href="/CustomerLogin">Already have an account?<i>Login</i></a>
