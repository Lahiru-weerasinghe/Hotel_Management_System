...
filterData(posts,searchKey){
  const result = posts.filter((post)=>
    post.name.toLowerCase().includes(searchKey)  //search by name
  )
  this.setState({posts:result})   //set the result
        ...
        <div className="row">
          <div className="col-lg-9 mt-2 mb-2">
            ...
            <div className="col-lg-3 mt-2 mb-2">
              ...
              placeholder="Search"
              name="searchQuery"
              onChange={this.handleSearchArea}   //identify the changes and update the value
              >
              </input>
            </div>
            </div>
